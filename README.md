...
Step 2：設定 MongoDB 環境變數（每次重啟 Terminal 都要設定）

以下三種方式 擇一即可：

export uri="mongodb+srv://webappgroup5:webappgroup5@cluster0.faxoia9.mongodb.net/"

Windows (PowerShell)

set MONGODB_URI=mongodb+srv://webappgroup5:webappgroup5@cluster0.faxoia9.mongodb.net/
